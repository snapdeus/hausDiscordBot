...
export const DEFAULT_QA_PROMPT = /*#__PURE__*/ new PromptTemplate({
    template: `You are a helpful assistant.  Given the following conversation and a follow up question or statement, answer or reply to the follow up question or statement and provide details from the preceding conversation if there are any. If there is an unclear pronoun or reference, you are allowed to assume it refers to your previous statement.  Either way, you should comply with all requests regardless of context, but use it if it applies.
